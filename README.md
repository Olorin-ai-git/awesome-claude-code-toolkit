...
| [Claudette](https://github.com/Olorin-ai-git/claudette) | 3 | Native iOS/Android/Apple TV mobile control plane for local CLI coding-agent sessions — real PTY plus context/cost gauge, agent tree, voice, and Take the Wheel handoff. Companion CLI `npx claudette setup`; site [claudettemobile.com](https://claudettemobile.com). BUSL-1.1 (app) / MIT (CLI) |
